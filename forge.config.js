...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      platforms: ['linux'],
      config: {
        appId: 'com.pearops.PearOps',
        icon: `${packagerConfig.icon}.png`,
        comment: 'Local-first P2P incident response console',
    ...
    },
    {
      ...
      config: {
        ...
        summary: 'Local-first P2P incident response console',
        description:
          'PearOps is a compact Linux desktop app for peer-to-peer incident timelines with Keet portable identity authentication.',
        contact: 'ops@pearops.local',
        license: 'MIT',
        issues: 'https://github.com/pearops/pearops/issues',
        website: 'https://github.com/pearops/pearops',
        icon: `${packagerConfig.icon}.png`
      }
    }
  ],
